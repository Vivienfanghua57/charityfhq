...
public class CustomListView extends ListView implements OnScrollListener {
    ...
    private void init(Context context) {
        setCacheColorHint(context.getResources().getColor(R.color.common_transparent));
        inflater = LayoutInflater.from(context);

        headView = (LinearLayout) inflater.inflate(R.layout.listviewhead, null);
...
//		arrowImageView.setMinimumHeight(50);
    ...
    public void addFooter(Context context){
        moreView = LayoutInflater.from(context).inflate(R.layout.listviewfoot, null);
...
//			arrowImageView.startAnimation(animation);
                tipsTextview.setText(getContext().getString(R.string.pull_to_refresh_pull_label));//s
...
//				arrowImageView.startAnimation(reverseAnimation);
                    ...
                    tipsTextview.setText(getContext().getString(R.string.pull_to_refresh));
                } else {
                    tipsTextview.setText(getContext().getString(R.string.pull_to_refresh));
                }
                break;
